// Pure (vscode-free) resolver for the awkrs binary, factored out of
...
// the editor's process does NOT inherit the shell PATH, so a bare `awkrs`
...
// Resolve `configured` (the `awk.path` setting, default "awkrs") to an
...
function resolveAwkBinary(configured, fallbackDirs = defaultFallbackDirs()) {
...
module.exports = { resolveAwkBinary, defaultFallbackDirs };
